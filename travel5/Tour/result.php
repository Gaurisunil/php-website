...
<body style="background-color: #000000;">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="home.php?status=loggedin"><b>India Tour</b></a>
    ...
    if(isset($_POST['GetResult']))
    {
        ...
        if(!empty($_POST['category']) || !empty($_POST['group']))
        {
            ...
            if($rows==0)
            {
                ...
                <div class="info">
                    <p style="color: #fafafa;">We are sorry! We could not find any location to match your requirements. Click <a href="home.php?status=loggedin">here</a> to browse other trips planned by IndiaTour.</p>
                </div>
            </div>';
            }
        }
