...
<body data-spy="scroll" data-target=".navbar" data-offset="10">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="#">India Tour</a>
    ...
    <div id="Home">
		...
		<div class="survey">
			...
			<div class="surveyBtn"><a href="survey.php"><button class="yellowBtn">GOEXPLORE</button></a></div>
		</div>
	</div> <!--home ends-->
  ...
  ?>
    ...
    <!--footer-->
    	...
    	<div class="container-fluid text-center text-md-left">
      		<div class="row">
        		<div class="col-md-6 mt-md-0 mt-3">
          			...
          			<p class="footerText"><i class="fa fa-envelope icon" aria-hidden="true"></i> help@IndiaTour.com</p>
          			<p class="footerText"><i class="fa fa-phone icon" aria-hidden="true"></i> 9920761587 (9:00 am to 9:00 pm)</p>	
        		</div>
    	...
    	<div class="footer-copyright text-center py-3 madeby">
    		Made by<font style="color: #ffc312;"> Gauri Sunil Chavan</font>
    	</div>
  	</footer>
<!--Bootstrap JS-->
